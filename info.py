...
BOT_TOKEN = '5675651874:AAGUnKVobKXIG9Pi5mxxn00zdyFhFjYLk2A' #(environ['BOT_TOKEN'],'5675651874:AAGUnKVobKXIG9Pi5mxxn00zdyFhFjYLk2A')
...
SPELL_CHECK_REPLY = is_enabled(environ.get("SPELL_CHECK_REPLY", "False"), Falsr)
